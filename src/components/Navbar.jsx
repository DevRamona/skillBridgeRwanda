...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#003566] p-6"> {/* Changed background color */}
      <div className="container mx-auto flex justify-between items-center">
        <Link to="/" className="text-white text-lg font-bold">
          SkillBridge
        </Link>
        <div className="flex items-center text-white mx-4">
          <Link to="/courses" className="mx-4">Courses</Link> {/* Link to Courses page */}
          <Link to="/job-matching" className="mx-4">Job Matching</Link>
          <Link to="/career-guidance"className="mx-4">Career Guidance</Link>
          <Link to="/progress-tracking"className="mx-4">Progress Tracking</Link>
          {user ? (
